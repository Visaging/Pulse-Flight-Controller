...
## Overview
This is a fully custom Flight Controller (FC) designed from the ground up.
Most people buy a stack and flash Betaflight. I wanted to understand the *entire* stack—from choosing the voltage regulator to writing the PID loop in C code. This repository contains the **Altium/KiCad PCB files** and the **STM32 Firmware** that runs the show.
